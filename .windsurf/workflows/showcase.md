...
Generate a visual comparison page that renders **the original URL and clone route provided by the user** side by side on a cinematic black background.

Parse `the original URL and clone route provided by the user` as two values:
